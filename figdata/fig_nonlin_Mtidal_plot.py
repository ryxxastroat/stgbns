...
grdata1 = np.genfromtxt('TOV_tidal_v1_data1.txt')
grdata2 = np.genfromtxt('TOV_tidal_v1_data2.txt')
grdata3 = np.genfromtxt('TOV_tidal_v1_data3.txt')
grdata4 = np.genfromtxt('TOV_tidal_v1_data4.txt')
grdata5 = np.genfromtxt('TOV_tidal_v1_data5.txt')
# ec, M, R, lambda, ytidal
a10, a11, a12, a13, a14 = grdata1[:, 0], grdata1[:, 1], grdata1[:, 2], grdata1[:, 3], grdata1[:, 4]
a20, a21, a22, a23, a24 = grdata2[:, 0], grdata2[:, 1], grdata2[:, 2], grdata2[:, 3], grdata2[:, 4]
a30, a31, a32, a33, a34 = grdata3[:, 0], grdata3[:, 1], grdata3[:, 2], grdata3[:, 3], grdata3[:, 4]
a40, a41, a42, a43, a44 = grdata4[:, 0], grdata4[:, 1], grdata4[:, 2], grdata4[:, 3], grdata4[:, 4]
a50, a51, a52, a53, a54 = grdata5[:, 0], grdata5[:, 1], grdata5[:, 2], grdata5[:, 3], grdata5[:, 4]
...
ax1.semilogy(a11/MSUN, a13, '--', color = colorset[0], label='$a$ = 1')
ax1.semilogy(a21/MSUN, a23, '--', color = colorset[1])
ax1.semilogy(a31/MSUN, a33, '--', color = colorset[2])
ax1.semilogy(a41/MSUN, a43, '--', color = colorset[3])
ax1.semilogy(a51/MSUN, a53, '--', color = colorset[4])
#ax2.set_ylim([Rmin, Rmax])
ax2.semilogy(a11/MSUN, a13, '--', color = colorset[0])
ax2.semilogy(a21/MSUN, a23, '--', color = colorset[1])
ax2.semilogy(a31/MSUN, a33, '--', color = colorset[2])
ax2.semilogy(a41/MSUN, a43, '--', color = colorset[3])
ax2.semilogy(a51/MSUN, a53, '--', color = colorset[4])
#ax3.set_ylim([Rmin, Rmax])
ax3.plot(a11/MSUN, a13, '--', color = colorset[0])
ax3.plot(a21/MSUN, a23, '--', color = colorset[1])
ax3.plot(a31/MSUN, a33, '--', color = colorset[2])
ax3.plot(a41/MSUN, a43, '--', color = colorset[3])
ax3.plot(a51/MSUN, a53, '--', color = colorset[4])
#ax4.set_ylim([Rmin, Rmax])
ax4.plot(a11/MSUN, a13, '--', color = colorset[0])
ax4.plot(a21/MSUN, a23, '--', color = colorset[1])
ax4.plot(a31/MSUN, a33, '--', color = colorset[2])
ax4.plot(a41/MSUN, a43, '--', color = colorset[3])
ax4.plot(a51/MSUN, a53, '--', color = colorset[4])
#ax5.set_ylim([Rmin, Rmax])
ax5.semilogy(a11/MSUN, a13, '--', color = colorset[0], label='$a$ = 0.1')
ax5.semilogy(a21/MSUN, a23, '--', color = colorset[1])
ax5.semilogy(a31/MSUN, a33, '--', color = colorset[2])
ax5.semilogy(a41/MSUN, a43, '--', color = colorset[3])
ax5.semilogy(a51/MSUN, a53, '--', color = colorset[4])
#ax6.set_ylim([Rmin, Rmax])
ax6.semilogy(a11/MSUN, a13, '--', color = colorset[0])
ax6.semilogy(a21/MSUN, a23, '--', color = colorset[1])
ax6.semilogy(a31/MSUN, a33, '--', color = colorset[2])
ax6.semilogy(a41/MSUN, a43, '--', color = colorset[3])
ax6.semilogy(a51/MSUN, a53, '--', color = colorset[4])
#ax7.set_ylim([Rmin, Rmax])
ax7.semilogy(a11/MSUN, a13, '--', color = colorset[0])
ax7.semilogy(a21/MSUN, a23, '--', color = colorset[1])
ax7.semilogy(a31/MSUN, a33, '--', color = colorset[2])
ax7.semilogy(a41/MSUN, a43, '--', color = colorset[3])
ax7.semilogy(a51/MSUN, a53, '--', color = colorset[4])
#ax8.set_ylim([Rmin, Rmax])
ax8.semilogy(a11/MSUN, a13, '--', color = colorset[0])
ax8.semilogy(a21/MSUN, a23, '--', color = colorset[1])
ax8.semilogy(a31/MSUN, a33, '--', color = colorset[2])
ax8.semilogy(a41/MSUN, a43, '--', color = colorset[3])
ax8.semilogy(a51/MSUN, a53, '--', color = colorset[4])

ax3.set_yscale('symlog') # log plot show the negative y axis
...
#ST M-tidal
#ec, bphclower, bphcupper, M, I, ytidal, dimllatidal, dimllatidal1, dimllatidal2, dimllatidal3, dimllatidal4
...
ax5.semilogy(x1, y1, color = colorset[0]) 
...
ax5.semilogy(x2, y2, color = colorset[1]) 
...
ax5.semilogy(x3, y3, color = colorset[2]) 
...
ax5.semilogy(x4, y4, color = colorset[3]) 
...
ax5.semilogy(x5, y5, color = colorset[4]) 
...
ax6.semilogy(x6, y6, color = colorset[0]) 
...
ax6.semilogy(x7, y7, color = colorset[1]) 
...
ax6.semilogy(x8, y8, color = colorset[2]) 
...
ax6.semilogy(x9, y9, color = colorset[3]) 
...
ax6.semilogy(x10, y10, color = colorset[4]) 
...
ax7.semilogy(x11, y11, color = colorset[0]) 
...
ax7.semilogy(x12, y12, color = colorset[1]) 
...
ax7.semilogy(x13, y13, color = colorset[2]) 
...
ax7.semilogy(x14, y14, color = colorset[3]) 
...
ax7.semilogy(x15, y15, color = colorset[4]) 
...
ax8.semilogy(x16, y16, color = colorset[0]) 
...
ax8.semilogy(x17, y17, color = colorset[1]) 
...
ax8.semilogy(x18, y18, color = colorset[2]) 
...
ax8.semilogy(x19, y19, color = colorset[3]) 
...
ax8.semilogy(x20, y20, color = colorset[4]) 
...
ax1.semilogy(x21, y21, color = colorset[0]) 
...
ax1.semilogy(x22, y22, color = colorset[1]) 
...
ax1.semilogy(x23, y23, color = colorset[2]) 
...
ax1.semilogy(x24, y24, color = colorset[3]) 
...
ax1.semilogy(x25, y25, color = colorset[4]) 
...
ax2.semilogy(x26, y26, color = colorset[0]) 
...
ax2.semilogy(x27, y27, color = colorset[1]) 
...
ax2.semilogy(x28, y28, color = colorset[2]) 
...
ax2.semilogy(x30, y30, color = colorset[4]) 
...
x31 = c331/MSUN 
y31 = c931 
ax3.plot(x31, y31, 'o', color = colorset[0]) 
ax3.plot(x31, y31, color = colorset[0]) 
...
x32 = c332/MSUN 
y32 = c932 
ax3.plot(x32, y32, 'o', color = colorset[1]) 
ax3.plot(x32, y32, color = colorset[1]) 
...
x33 = c333/MSUN 
y33 = c933 
ax3.plot(x33, y33, 'o', color = colorset[2]) 
ax3.plot(x33, y33, color = colorset[2]) 
...
x34 = c334/MSUN 
y34 = c934 
ax3.plot(x34, y34, 'o', color = colorset[3]) 
ax3.plot(x34, y34, color = colorset[3]) 
...
x35 = c335/MSUN 
y35 = c935 
ax3.plot(x35, y35, 'o', color = colorset[4]) 
ax3.plot(x35, y35, color = colorset[4]) 
...
x36 = c336/MSUN 
y36 = c936 
ax4.plot(x36, y36, 'o', color = colorset[0]) 
ax4.plot(x36, y36, color = colorset[0]) 
...
x37 = c337/MSUN 
y37 = c937 
ax4.plot(x37, y37, 'o', color = colorset[1]) 
ax4.plot(x37, y37, color = colorset[1]) 
...
x38 = c338/MSUN 
y38 = c938 
ax4.plot(x38, y38, 'o', color = colorset[2]) 
ax4.plot(x38, y38, color = colorset[2]) 
...
x39 = c339/MSUN 
y39 = c939 
ax4.plot(x39, y39, 'o', color = colorset[3]) 
ax4.plot(x39, y39, color = colorset[3]) 
...
x40 = c340/MSUN 
y40 = c940 
ax4.plot(x40, y40, 'o', color = colorset[4]) 
ax4.plot(x40, y40, color = colorset[4]) 
