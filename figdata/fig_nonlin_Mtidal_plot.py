...
ax3.semilogy(a11/MSUN, a13, '--', color = colorset[0])
ax3.semilogy(a21/MSUN, a23, '--', color = colorset[1])
ax3.semilogy(a31/MSUN, a33, '--', color = colorset[2])
ax3.semilogy(a41/MSUN, a43, '--', color = colorset[3])
ax3.semilogy(a51/MSUN, a53, '--', color = colorset[4])
#ax4.set_ylim([Rmin, Rmax])
ax4.semilogy(a11/MSUN, a13, '--', color = colorset[0])
ax4.semilogy(a21/MSUN, a23, '--', color = colorset[1])
ax4.semilogy(a31/MSUN, a33, '--', color = colorset[2])
ax4.semilogy(a41/MSUN, a43, '--', color = colorset[3])
ax4.semilogy(a51/MSUN, a53, '--', color = colorset[4])
...
ax3.semilogy(x31, y31, color = colorset[0]) 
...
ax3.semilogy(x32, y32, color = colorset[1]) 
...
ax3.semilogy(x33, y33, color = colorset[2]) 
...
ax3.semilogy(x34, y34, color = colorset[3]) 
...
ax3.semilogy(x35, y35, color = colorset[4]) 
...
ax4.semilogy(x36, y36, color = colorset[0]) 
...
ax4.semilogy(x37, y37, color = colorset[1]) 
...
ax4.semilogy(x38, y38, color = colorset[2]) 
...
ax4.semilogy(x39, y39, color = colorset[3]) 
...
ax4.semilogy(x40, y40, color = colorset[4]) 
