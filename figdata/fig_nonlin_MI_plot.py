...
ax1.plot(a11/MSUN, a14, '--', color = colorset[0], label='$a$ = 1')
ax1.plot(a21/MSUN, a24, '--', color = colorset[1])
ax1.plot(a31/MSUN, a34, '--', color = colorset[2])
ax1.plot(a41/MSUN, a44, '--', color = colorset[3])
ax1.plot(a51/MSUN, a54, '--', color = colorset[4])
#ax2.set_xlim([Rmin, Rmax])
ax2.plot(a11/MSUN, a14, '--', color = colorset[0])
ax2.plot(a21/MSUN, a24, '--', color = colorset[1])
ax2.plot(a31/MSUN, a34, '--', color = colorset[2])
ax2.plot(a41/MSUN, a44, '--', color = colorset[3])
ax2.plot(a51/MSUN, a54, '--', color = colorset[4])
#ax3.set_xlim([Rmin, Rmax])
ax3.plot(a11/MSUN, a14, '--', color = colorset[0])
ax3.plot(a21/MSUN, a24, '--', color = colorset[1])
ax3.plot(a31/MSUN, a34, '--', color = colorset[2])
ax3.plot(a41/MSUN, a44, '--', color = colorset[3])
ax3.plot(a51/MSUN, a54, '--', color = colorset[4])
#ax4.set_xlim([Rmin, Rmax])
ax4.plot(a11/MSUN, a14, '--', color = colorset[0])
ax4.plot(a21/MSUN, a24, '--', color = colorset[1])
ax4.plot(a31/MSUN, a34, '--', color = colorset[2])
ax4.plot(a41/MSUN, a44, '--', color = colorset[3])
ax4.plot(a51/MSUN, a54, '--', color = colorset[4])
#ax5.set_xlim([Rmin, Rmax])
ax5.plot(a11/MSUN, a14, '--', color = colorset[0], label='$a$ = 0.1')
ax5.plot(a21/MSUN, a24, '--', color = colorset[1])
ax5.plot(a31/MSUN, a34, '--', color = colorset[2])
ax5.plot(a41/MSUN, a44, '--', color = colorset[3])
ax5.plot(a51/MSUN, a54, '--', color = colorset[4])
#ax6.set_xlim([Rmin, Rmax])
ax6.plot(a11/MSUN, a14, '--', color = colorset[0])
ax6.plot(a21/MSUN, a24, '--', color = colorset[1])
ax6.plot(a31/MSUN, a34, '--', color = colorset[2])
ax6.plot(a41/MSUN, a44, '--', color = colorset[3])
ax6.plot(a51/MSUN, a54, '--', color = colorset[4])
#ax7.set_xlim([Rmin, Rmax])
ax7.plot(a11/MSUN, a14, '--', color = colorset[0])
ax7.plot(a21/MSUN, a24, '--', color = colorset[1])
ax7.plot(a31/MSUN, a34, '--', color = colorset[2])
ax7.plot(a41/MSUN, a44, '--', color = colorset[3])
ax7.plot(a51/MSUN, a54, '--', color = colorset[4])
#ax8.set_xlim([Rmin, Rmax])
ax8.plot(a11/MSUN, a14, '--', color = colorset[0])
ax8.plot(a21/MSUN, a24, '--', color = colorset[1])
ax8.plot(a31/MSUN, a34, '--', color = colorset[2])
ax8.plot(a41/MSUN, a44, '--', color = colorset[3])
ax8.plot(a51/MSUN, a54, '--', color = colorset[4])
...
x1 = c31/MSUN 
y1 = c41 
ax5.plot(x1, y1, 'o', color = colorset[0]) 
...
x2 = c32/MSUN 
y2 = c42 
ax5.plot(x2, y2, 'o', color = colorset[1]) 
...
x3 = c33/MSUN 
y3 = c43 
ax5.plot(x3, y3, 'o', color = colorset[2]) 
...
x4 = c34/MSUN 
y4 = c44 
ax5.plot(x4, y4, 'o', color = colorset[3]) 
...
x5 = c35/MSUN 
y5 = c45 
ax5.plot(x5, y5, 'o', color = colorset[4]) 
...
x6 = c36/MSUN 
y6 = c46 
ax6.plot(x6, y6, 'o', color = colorset[0]) 
...
x7 = c37/MSUN 
y7 = c47 
ax6.plot(x7, y7, 'o', color = colorset[1]) 
...
x8 = c38/MSUN 
y8 = c48 
ax6.plot(x8, y8, 'o', color = colorset[2]) 
...
x9 = c39/MSUN 
y9 = c49 
ax6.plot(x9, y9, 'o', color = colorset[3]) 
...
x10 = c310/MSUN 
y10 = c410 
ax6.plot(x10, y10, 'o', color = colorset[4]) 
...
x11 = c311/MSUN 
y11 = c411 
ax7.plot(x11, y11, 'o', color = colorset[0]) 
...
x12 = c312/MSUN 
y12 = c412 
ax7.plot(x12, y12, 'o', color = colorset[1]) 
...
x13 = c313/MSUN 
y13 = c413 
ax7.plot(x13, y13, 'o', color = colorset[2]) 
...
x14 = c314/MSUN 
y14 = c414 
ax7.plot(x14, y14, 'o', color = colorset[3]) 
...
x15 = c315/MSUN 
y15 = c415 
ax7.plot(x15, y15, 'o', color = colorset[4]) 
...
x16 = c316/MSUN 
y16 = c416 
ax8.plot(x16, y16, 'o', color = colorset[0]) 
...
x17 = c317/MSUN 
y17 = c417 
ax8.plot(x17, y17, 'o', color = colorset[1]) 
...
x18 = c318/MSUN 
y18 = c418 
ax8.plot(x18, y18, 'o', color = colorset[2]) 
...
x19 = c319/MSUN 
y19 = c419 
ax8.plot(x19, y19, 'o', color = colorset[3]) 
...
x20 = c320/MSUN 
y20 = c420 
ax8.plot(x20, y20, 'o', color = colorset[4]) 
...
x21 = c321/MSUN 
y21 = c421 
ax1.plot(x21, y21, 'o', color = colorset[0]) 
...
x22 = c322/MSUN 
y22 = c422 
ax1.plot(x22, y22, 'o', color = colorset[1]) 
...
x23 = c323/MSUN 
y23 = c423 
ax1.plot(x23, y23, 'o', color = colorset[2]) 
...
x24 = c324/MSUN 
y24 = c424 
ax1.plot(x24, y24, 'o', color = colorset[3]) 
...
x25 = c325/MSUN 
y25 = c425 
ax1.plot(x25, y25, 'o', color = colorset[4]) 
...
x26 = c326/MSUN 
y26 = c426 
ax2.plot(x26, y26, 'o', color = colorset[0]) 
...
x27 = c327/MSUN 
y27 = c427 
ax2.plot(x27, y27, 'o', color = colorset[1]) 
...
x28 = c328/MSUN 
y28 = c428 
ax2.plot(x28, y28, 'o', color = colorset[2]) 
...
x30 = c330/MSUN 
y30 = c430 
ax2.plot(x30, y30, 'o', color = colorset[4]) 
