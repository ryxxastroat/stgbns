...
class EOS(object):
    ...
    def __init__(self, name='AP4'):
        ...
        self.lge2lgpder = interpolate.splrep(lgp, lge, s=3)
    ...
    def p2csq(self, p):
        dlgedlgp = interpolate.splev(lg(p), self.lge2lgpder, der=1)
        return p/self.p2e(p) * 1./dlgedlgp
...
if __name__ == '__main__':
    ...
    ax3.set_xlabel(r'$p \,[{\rm g\,cm}^{-3}]$', fontsize=20)
    ax3.set_ylabel(r'$c^2 \,[{\rm g\,cm}^{-3}]$', fontsize=20)
