...
(* ::Input:: *)
(*(* I. calculate the field equations using spherical decomposition; 2 hrs 3 mins *)*)
...
(* ::Input:: *)
(*(* Cell 3: define the odd perturbation functions: {oh0f, oh1f, owf} \[LongLeftRightArrow] {Subscript[h, 0], Subscript[h, 1], Subscript[h, 2]}*)*)


(* ::Input::Initialization:: *)
oh0=oh0f[t,r];oh1=oh1f[t,r];ometric1=po*{{0,0,-oh0*(1/Sin[th])*D[SphericalHarmonicY[l,m,th,ph],ph],oh0*Sin[th]*D[SphericalHarmonicY[l,m,th,ph],th]},{0,0,-oh1*(1/Sin[th])*D[SphericalHarmonicY[l,m,th,ph],ph],oh1*Sin[th]*D[SphericalHarmonicY[l,m,th,ph],th]},{-oh0*(1/Sin[th])*D[SphericalHarmonicY[l,m,th,ph],ph],-oh1*(1/Sin[th])*D[SphericalHarmonicY[l,m,th,ph],ph],0,0},{oh0*Sin[th]*D[SphericalHarmonicY[l,m,th,ph],th],oh1*Sin[th]*D[SphericalHarmonicY[l,m,th,ph],th],0,0}};fluow=owf[t,r];odisxdown=po*{0,0,-fluow/Sin[th]*D[SphericalHarmonicY[l,m,th,ph],ph],fluow*Sin[th]*D[SphericalHarmonicY[l,m,th,ph],th]};odisxup=Table[Sum[odisxdown[[i1]]*inversemetric0[[i,i1]],{i1,1,n}],{i,1,n}];odebph=0;
...
(* ::Input::Initialization:: *)
metricp=ometric1;metric=metric0+metricp;inversemetric=Simplify[Normal[Series[Inverse[metric],{po,0,1}]],Assumptions->l>m>0];disxup=odisxup;disxdown=odisxdown;debph=odebph;bph=bphf[r]+debph;
...
(* ::Input::Initialization:: *)
expricci=Simplify[Series[ricci,{po,0,1}]/.{SphericalHarmonicY[l,m,th,ph]->ylm,SphericalHarmonicY[l,m+1,th,ph]->ylm1,SphericalHarmonicY[l,m+2,th,ph]->ylm2iter,SphericalHarmonicY[l,m+3,th,ph]->ylm3iter},Assumptions->{l>m>0}];expricci>>"exp_o_ricci.txt";expeinstein=Simplify[Series[einstein,{po,0,1}]/.{SphericalHarmonicY[l,m,th,ph]->ylm,SphericalHarmonicY[l,m+1,th,ph]->ylm1,SphericalHarmonicY[l,m+2,th,ph]->ylm2iter,SphericalHarmonicY[l,m+3,th,ph]->ylm3iter},Assumptions->{l>m>0}];expeinstein>>"exp_o_eins.txt";
...
(* ::Input::Initialization:: *)
exptgbmn=Simplify[Series[tgbtensdown,{po,0,1}]/.{SphericalHarmonicY[l,m,th,ph]->ylm,SphericalHarmonicY[l,m+1,th,ph]->ylm1,SphericalHarmonicY[l,m+2,th,ph]->ylm2iter,SphericalHarmonicY[l,m+3,th,ph]->ylm3iter},Assumptions->{l>m>0}];exptgbmn>>"exp_o_tgb.txt";expsgbmn=Simplify[Series[sgbmn,{po,0,1}]/.{SphericalHarmonicY[l,m,th,ph]->ylm,SphericalHarmonicY[l,m+1,th,ph]->ylm1,SphericalHarmonicY[l,m+2,th,ph]->ylm2iter,SphericalHarmonicY[l,m+3,th,ph]->ylm3iter},Assumptions->{l>m>0}];expsgbmn>>"exp_o_sgb.txt";
...
(* ::Input::Initialization:: *)
exptphmn=Simplify[Series[tphmn,{po,0,1}]/.{SphericalHarmonicY[l,m,th,ph]->ylm,SphericalHarmonicY[l,m+1,th,ph]->ylm1,SphericalHarmonicY[l,m+2,th,ph]->ylm2iter,SphericalHarmonicY[l,m+3,th,ph]->ylm3iter},Assumptions->{l>m>0}];exptphmn>>"exp_o_tph.txt";expsphmn=Simplify[Series[sphmn,{po,0,1}]/.{SphericalHarmonicY[l,m,th,ph]->ylm,SphericalHarmonicY[l,m+1,th,ph]->ylm1,SphericalHarmonicY[l,m+2,th,ph]->ylm2iter,SphericalHarmonicY[l,m+3,th,ph]->ylm3iter},Assumptions->{l>m>0}];expsphmn>>"exp_o_sph.txt";
...
(* ::Input::Initialization:: *)
expconseq=Simplify[Series[conseq,{po,0,1}]/.{SphericalHarmonicY[l,m,th,ph]->ylm,SphericalHarmonicY[l,m+1,th,ph]->ylm1,SphericalHarmonicY[l,m+2,th,ph]->ylm2iter,SphericalHarmonicY[l,m+3,th,ph]->ylm3iter},Assumptions->{l>m>0}];expconseq>>"exp_o_coneq.txt";
...
(* ::Input::Initialization:: *)
expscalareq=Simplify[Series[scalareq,{po,0,1}]/.{SphericalHarmonicY[l,m,th,ph]->ylm,SphericalHarmonicY[l,m+1,th,ph]->ylm1,SphericalHarmonicY[l,m+2,th,ph]->ylm2iter,SphericalHarmonicY[l,m+3,th,ph]->ylm3iter},Assumptions->{l>m>0}];expscalareq>>"exp_o_scalareq.txt";
...
(* ::Input:: *)
(*(* define the convariant basis *)*)


(* ::Input::Initialization:: *)
basisv={-1/Sin[th]*D[SphericalHarmonicY[l,m,th,ph],ph],Sin[th]*D[SphericalHarmonicY[l,m,th,ph],th]};basist={1/Sin[th]*(D[SphericalHarmonicY[l,m,th,ph],th,ph]-Cot[th]*D[SphericalHarmonicY[l,m,th,ph],ph]),1/2*(1/Sin[th]*D[SphericalHarmonicY[l,m,th,ph],ph,ph]+Cos[th]*D[SphericalHarmonicY[l,m,th,ph],th]-Sin[th]*D[SphericalHarmonicY[l,m,th,ph],th,th]),-Sin[th]*(D[SphericalHarmonicY[l,m,th,ph],th,ph]-Cot[th]*D[SphericalHarmonicY[l,m,th,ph],ph])};basisv=Simplify[basisv/.{SphericalHarmonicY[l,m,th,ph]->ylm,SphericalHarmonicY[l,m+1,th,ph]->ylm1,SphericalHarmonicY[l,m+2,th,ph]->ylm2iter},Assumptions->{l>m>0}];basist=Simplify[basist/.{SphericalHarmonicY[l,m,th,ph]->ylm,SphericalHarmonicY[l,m+1,th,ph]->ylm1,SphericalHarmonicY[l,m+2,th,ph]->ylm2iter},Assumptions->{l>m>0}];
...
(* ::Input::Initialization:: *)
ricci=<<"exp_o_ricci.txt";sgbmn=<<"exp_o_sgb.txt";sphmn=<<"exp_o_sph.txt";smmn=<<"exp_o_sm.txt";scalareq=<<"exp_o_scalareq.txt";
conseq=<<"exp_o_coneq.txt";
einstein=<<"exp_o_eins.txt";tgbmn=<<"exp_o_tgb.txt";tphmn=<<"exp_o_tph.txt";tmmn=<<"exp_o_tm.txt";
ricci0=Coefficient[ricci,po,0];riccip=Coefficient[ricci,po,1];sgbmn0=Coefficient[sgbmn,po,0];sgbmnp=Coefficient[sgbmn,po,1];sphmn0=Coefficient[sphmn,po,0];sphmnp=Coefficient[sphmn,po,1];smmn0=Coefficient[smmn,po,0];smmnp=Coefficient[smmn,po,1];scalareq0=Coefficient[scalareq,po,0];scalareqp=Coefficient[scalareq,po,1];
...
(* ::Input::Initialization:: *)
eeq0=Simplify[Table[einstein0[[i,j]]-tgbmn0[[i,j]]-tphmn0[[i,j]]-ka*tmmn0[[i,j]],{i,1,n},{j,1,n}]];eq0={eeq0[[1]],eeq0[[2]],eeq0[[3]],eeq0[[4]],conseq0[[1]],scalareq0};eq0>>"eqs_order0_check.txt";
...
(* ::Input::Initialization:: *)
eeq1=Table[einsteinp[[i,j]]-tgbmnp[[i,j]]-tphmnp[[i,j]]-ka*tmmnp[[i,j]],{i,1,n},{j,1,n}]/.{SphericalHarmonicY[l,m+3,th,ph]->ylm3iter};deeo0=Simplify[eeq1[[1,3]]/basisv[[1]]];deeo1=Simplify[eeq1[[2,3]]/basisv[[1]]];deeo2=Simplify[Coefficient[eeq1[[3,3]],ylm]/(I m Csc[th] (-1+m) Cot[th])];deconseq1=Simplify[conseqp[[3]]/basisv[[1]]/.{pf'[r]->-(epf[r] Derivative[1][bf][r]+pf[r] Derivative[1][bf][r])/(2 bf[r])}];eq1={deeo0,deeo0,deeo0,deconseq1};eq1>>"eqs_odd_order1.txt";
